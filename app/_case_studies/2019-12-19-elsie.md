...
s_feature_quote:
  quote:  Major helped us redefine our product strategy. Their exciting contributions to branding, communication, design and user experience made it possible for the team to craft a new Elsie.
  source: Pedro Lopes, Head of Product at Elsie
  bgcolor: '#5A48A4'
...
s_content:
  ...
  - type: section-tl
    ...
    content: |
      What are the main problems that led Elsie to come to us? With whom and how is Elsie communicating? Who is looking for Elsie and why? Who are the business partners? Who are the product users?
      A set of genetically structured questions to get to know Elsie.
    images:
  ...
  - type: section-tl
    ...
    content: |
      Listening to those who were profoundly knowledgeable about the genetics business has created the space for us, together with Elsie team, to point in a direction of intervention. A roadmap was created which included the redefinition of the brand, the redesign of the website and the platform.
    images:
